...
const customActions = [
    ...
    },
    {
        ...
        leveling: {
            ...
            minRate: defaultActionRate.min,
            rateOfChange: 0.01,
            rateOfChangeFailureMultiplier: 0.5,
            decreaseRate: 0.001 / 6
        },
        coolDown: {
            enabled: true,
    ...
    eventSystem: [
        {
            ...
            events: [
                ...
                { chance: 0.25, description: 'There is a thick fog outside.' },
                { chance: 0.15, description: 'There are clouds outside.' },
                { chance: 0.1, description: 'There are clouds and precipitation outside.' },
                { chance: 0.05, description: 'It is thundering outside.' }
            ],
            // The chance of the event system changing events.
            chance: 0.1,
            // The current event within the event system.
            current: { chance: 0.05, description: 'It is thundering outside.' },
...
const oracle = () => {
    ...
    const getActionByName = (player, actionName) => {
        ...
        if (actionName !== '') {
            ...
            const newActionName = convertVerbTense(actionName)
            if (!action) {
